    ...
    "translations": {
      "en": {
        "consentModal": {
          ...
          "description": "PC.Solution,Inc uses cookies to enhance your experience, analyze site usage, and assist in our marketing efforts. You can manage your preferences anytime.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: '9f05c7fe-8d10-417c-8446-73228b01a58f',
                    name: data.name || '',
                    email: data.email || '',
